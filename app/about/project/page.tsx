  ...
  return (
    <>
      <PageHero
        ...
        icon={Info}
        variant="image"
        backgroundImage="https://ik.imagekit.io/boostkit/East-Wear-Bay/About/About-Seaview-EWB.webp?updatedAt=1758121023033"
      />
          ...
          <section className="mb-16">
            ...
            <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div className="relative rounded-lg overflow-hidden h-[300px]">
                <Image
                  src="https://ik.imagekit.io/boostkit/East-Wear-Bay/About/About-Mission-EWB.webp?updatedAt=1758121022793"
          ...
          <section className="mb-16">
            ...
            <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-2">
              <div className="relative rounded-lg overflow-hidden h-[300px] md:order-2">
                <Image
                  src="https://ik.imagekit.io/boostkit/East-Wear-Bay/About/About-Archaeology-EWB.webp?updatedAt=1758121023605"
            ...
            <div className="mt-6">
              <div className="rounded-lg border p-6">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="relative rounded-lg overflow-hidden h-[200px]">
                    <Image
                      src="https://ik.imagekit.io/boostkit/East-Wear-Bay/About/About-Rescue-EWB.webp?updatedAt=1758121023317"
              ...
              <div className="mt-4 rounded-lg border p-6">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="relative rounded-lg overflow-hidden h-[200px] md:order-1">
                    <Image
                      src="https://ik.imagekit.io/boostkit/East-Wear-Bay/About/About-Digital-EWB.webp?updatedAt=1758121022645"
              ...
              <div className="mt-4 rounded-lg border p-6">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="relative rounded-lg overflow-hidden h-[200px]">
                    <Image
                      src="https://ik.imagekit.io/boostkit/East-Wear-Bay/About/About-Community-EWB.webp?updatedAt=1758121022074"
              ...
              <div className="mt-4 rounded-lg border p-6">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="relative rounded-lg overflow-hidden h-[200px] md:order-1">
                    <Image
                      src="https://ik.imagekit.io/boostkit/East-Wear-Bay/About/Academic-About-EWB.webp?updatedAt=1758121024363"
