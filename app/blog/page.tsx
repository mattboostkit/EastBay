...
export const metadata: Metadata = {
  title: 'News and Onsite Blog | East Wear Bay Archaeological Project',
      ...
      <div className="bg-muted py-12 md:py-20">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-3xl font-bold tracking-tight md:text-4xl">News and Onsite Blog</h1>
            <p className="mt-4 text-lg text-muted-foreground">
              Updates from our excavations and community projects during active field seasons.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg border bg-card shadow-sm">
            <div className="relative h-48">
              <Image
                src="https://cdn.sanity.io/images/ce9tlzu0/production/deb19698014c3332dc3ce9aeb12228d7f8a2b5f8-2016x1512.jpg"
                alt="3D scanning equipment being used to document artefacts from the East Wear Bay site"
                fill
            ...
            <div className="p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground line-clamp-3">
                ...
                to expand our digital preservation efforts, allowing for comprehensive 3D documentation of the site and artefacts.
              </p>
          ...
          <div className="rounded-lg border bg-card shadow-sm">
            <div className="relative h-48">
              <Image
                src="https://cdn.sanity.io/images/ce9tlzu0/production/deb19698014c3332dc3ce9aeb12228d7f8a2b5f8-2016x1512.jpg"
                alt="Conservation work being performed on a Roman pottery artefact in the laboratory"
                fill
                className="rounded-t-lg object-cover"
              />
            </div>
