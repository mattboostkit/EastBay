        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            ...
            <div className="mt-6 flex space-x-4">
              <a href="https://linkedin.com/company/eastwearbaypt" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground" aria-label="LinkedIn">
